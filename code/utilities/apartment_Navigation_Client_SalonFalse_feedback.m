...
deleteTrialPathSaveSelectedClass(TrialPath, selectedClassPath, 1);
        ...
        rot_ori=linspace(Viewpoint.ori_SalonFalse(4),-Viewpoint.ori_BedBathDoor(4)+6.283,L);
        for i=1:L
...
deleteTrialPathSaveSelectedClass(TrialPath, selectedClassPath, 3);
        ...
        rot_ori=linspace(Viewpoint.ori_SalonFalse(4),-Viewpoint.ori_BedroomDoor(4)+6.283,L);
        for i=1:L
            setfield(object_nodes(27),'position',[x_pos(i) y_pos(i) z_pos(i)]);
            setfield(object_nodes(27),'orientation',[x_ori(i) y_ori(i) z_ori(i) rot_ori(i)]);
            vrdrawnow
